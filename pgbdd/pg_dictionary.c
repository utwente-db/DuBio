...
select dictionary('mydict');
select dictionary_print(dictionary('mydict'));
select dictionary_add(dictionary('mydict'),'x=0 : 0.6; x=1 : 0.4; '); 
select dictionary_print(dictionary_add(dictionary('mydict'),'x=0 : 0.6; x=1 : 0.4; '));
